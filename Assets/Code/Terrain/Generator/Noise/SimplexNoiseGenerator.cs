...
public class SimplexNoiseGenerator
{
    ...
    public float coherentNoise(float x, float y, float z, float scale, float amplitude, float lacunarity, float persistence, int octaves)
    {
        Vector3 v3 = new Vector3(x, y, z) / scale;
        float val = 0;
